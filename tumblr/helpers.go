...
func (api client) info(url string, responseObject interface{}) {
...
// url - The GET URL
func (api client) rawGet(url string) []byte {
...
// url - The GET URL
func (api client) get(url string) Response {
	body := api.rawGet(url)
...
func (api client) post(url string, params string) Response {
