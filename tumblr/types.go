...
// Response The following type corresponds to the response message
...
// BlogInfo /info — Retrieve Blog Info
...
// BlogFollowers - /followers — Retrieve a Blog's Followers
...
// BlogPosts - /posts – Retrieve Published Posts
...
// Post represents info about single tumblr post
type Post struct {
	...
	Summary     string   `json:"summary"`      // User supplied summary for the post
	// Text posts
...
// UserInfo /user/info – Get a User's Information
